...
export default function Home() {
  ...
  return (
    <div className="relative bg-gray-100 min-h-screen md:bg-gray-100">
      ...
      {
        !signUpClick &&
        <div className="font-sans bg-white rounded-3xl shadow-2xl shadow-yellow-300 m-auto w-80 md:m-auto md:w-120">
          ...
          <form>
            <div className="flex flex-col">
              ...
              <button onClick={handleForgotPassword} className="flex justify-end font-sans my-2 mx-4 text-md text-red-500 font-semibold hover:cursor-pointer">Forgot Password?</button>
            </div>
          </form>
      ...
      {
        signUpClick &&
        <div className="font-sans bg-white rounded-3xl shadow-2xl shadow-yellow-300 m-auto w-70 md:m-auto md:w-120">
