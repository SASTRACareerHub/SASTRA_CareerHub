...
export default function Home() {
  ...
  return (
    <div className="relative bg-gray-100 min-h-screen md:bg-gray-100">
      ...
      {
        !signUpClick &&
        <div className="font-sans bg-white rounded-3xl my-10 shadow-2xl m-auto h-80 w-70 md:m-auto md:my-10 md:h-80 md:w-120">
          ...
          <form>
            <div className="flex flex-col">
              <input required className="font-sans p-2 rounded-lg m-4 border border-gray-400 h-10" type="email" placeholder="SASTRA Email"/>
              <input required className="font-sans p-2 rounded-lg mx-4 border border-gray-400 h-10" type="password" placeholder="Password"/>
              <button type="submit" className="font-sans rounded-lg m-4 text-white text-xl bg-gray-400 h-10 hover:cursor-pointer">Sign In</button>
            </div>
          </form>
      ...
      {
        signUpClick &&
        <div className="font-sans bg-white rounded-3xl my-5 shadow-2xl m-auto h-110 w-70 md:m-auto md:my-5 md:h-110 md:w-120">
          <h1 className="select-none flex justify-center font-sans font-semibold text-2xl pt-2">Sign Up</h1>
          <h1 className="select-none flex justify-center mx-2 md:mx-0 font-sans text-sm md:text-lg text-gray-600 pb-2 italic">Streamline Your Journey to Success</h1>
          <hr className="text-gray-400"></hr>
          <form>
            <div className="flex flex-col">
              <input required className="font-sans p-2 rounded-lg m-4 border border-gray-400 h-10" type="text" placeholder="Name"/>
              <input required className="font-sans p-2 rounded-lg mx-4 border border-gray-400 h-10" type="email" placeholder="SASTRA Email"/>
              <input required className="font-sans p-2 rounded-lg m-4 border border-gray-400 h-10" type="password" placeholder="Password"/>
              <input required className="font-sans p-2 rounded-lg mx-4 border border-gray-400 h-10" type="password" placeholder="Confirm Password"/>
              <button type="submit" className="font-sans rounded-lg m-4 text-white text-xl bg-gray-400 h-10 hover:cursor-pointer">Sign Up</button>
            </div>
          </form>
          <div className="flex flex-row justify-center">
